...
\end{table}
Adcionalmente se presenta el costo de manufactura de \ac{PCB}s en el mercado local peruano, en la Tabla \ref{tab:costo_pcbs_pruebas} se presenta el costo de la manufactura de una \ac{PCB} de pruebas de un tamaño reducido 
\begin{table}[H]
\centering
