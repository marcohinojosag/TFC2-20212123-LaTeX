...
\begin{landscape}
\label{plano base}
\includepdf[pages=1, landscape=true, fitpaper=true]{ANNEX/Fig/AT/ESQUEMATICOS.pdf}
\end{landscape}

\begin{landscape}
\label{plano base}
\includepdf[pages=2, landscape=true, fitpaper=true]{ANNEX/Fig/AT/ESQUEMATICOS.pdf}
\end{landscape}