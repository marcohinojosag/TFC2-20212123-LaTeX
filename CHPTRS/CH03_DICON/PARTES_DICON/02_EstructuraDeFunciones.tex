    ...
    \begin{figure}[H]
        ...
        \begin{tabularx}{\linewidth}{>{\centering\arraybackslash}X}
            ...
            \begin{subfigure}[t]{\linewidth}
                \centering
                \includegraphics[width=\linewidth]{CHPTRS/CH03_DICON/Fig/CH03_FIG01_EstructuraDeFunciones/01_BlackBox.pdf}
            \end{subfigure}
        \end{tabularx}
        \caption{Caja negra}
        \label{fig:black_box}
...
\subsection{Estructura de funciones}
    ...
    A continuación se presentarán cada uno de los dominios con las respectivas funciones, necesarias para diseñar el estimador de parámetros de motores \ac{DC}. La estructura completa se presenta en el Anexo \ref{an:Anexo_F_EstructuraDeFunciones}.
\subsection{Dominio de Interfaz}
	...
	\begin{itemize}
		...
		\item La señal de entrada al motor, en el capítulo \ref{ch:CH02-Estado-del-Arte}, se observa que para la caracterización de un motor es necesario realizar pruebas con distintos tipos de entrada para obtener con certeza cada uno de los parámetros a estimar.
    ...
    \begin{figure}[H]
        ...
        \begin{tabularx}{\linewidth}{>{\centering\arraybackslash}X}
            ...
            \begin{subfigure}[t]{0.8\linewidth}
                \centering
                \includegraphics[width=\linewidth]{CHPTRS/CH03_DICON/Fig/CH03_FIG01_EstructuraDeFunciones/04_EstructuraDeFunciones-Control.pdf}
            \end{subfigure}
        \end{tabularx}
    ...
    \begin{figure}[H]
        ...
        \begin{tabularx}{\linewidth}{>{\centering\arraybackslash}X}
            ...
            \begin{subfigure}[t]{0.9\linewidth}
                \centering
                \includegraphics[width=\linewidth]{CHPTRS/CH03_DICON/Fig/CH03_FIG01_EstructuraDeFunciones/05_EstructuraDeFunciones-Sensores.pdf}
            \end{subfigure}
        \end{tabularx}
    ...
    \begin{figure}[H]
        ...
        \begin{tabularx}{\linewidth}{>{\centering\arraybackslash}X}
            ...
            \begin{subfigure}[t]{0.95\linewidth}
                \centering
                \includegraphics[width=\linewidth]{CHPTRS/CH03_DICON/Fig/CH03_FIG01_EstructuraDeFunciones/07_EstructuraDeFunciones-Mecanica.pdf}
            \end{subfigure}
        \end{tabularx}
