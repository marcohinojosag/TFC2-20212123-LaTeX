...
\begin{figure}[H]
    ...
    \end{figure}
     ...
     \begin{figure}[H]
       \centering
       \includegraphics[width=0.5\textwidth]{CHPTRS/CH03_DICON/Fig/CH03_FIG03_SolucionOptima/03_SO_SoporteDeMotorPequeno.jpg}
