...
\ihead[]{Capítulo 2: Revisión de la literatura}
\label{ch:CH02}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent
...
De manera complementaria, en el Anexo~\ref{an:Anexo_C} se desarrolla el marco teórico que sustenta esta investigación, proporcionando el contexto del modelado de los motores \ac{DC}, las variables involucradas, la descripción de las pruebas empíricas consideradas y los fundamentos de los algoritmos de estimación que se implementarán.
\section{Softwares comerciales}
    ...
    \subsection{MATLAB/Motor Control Blockset}
        ...
        \begin{tabularx}{\linewidth}{>{\centering\arraybackslash}X}
            ...
            \label{fig:CH02_SW_MTLAB}
        \end{figure}
    %A continuación se presenta en la Tabla \ref{tab:comparasion_sw} tabla comparativa entre los dos \ac{SW} presentados, 
    Se compararán el precio para adquirir estas herramientas, si cumplen con estimar los parámetros de motor y qué tanta documentación se le brinda al usuario. Toda información en dicha tabla ha sido consultada a las páginas oficiales de cada \ac{SW}.
...
\section{Empresas de confianza}
    ...
    \begin{table}[H]
        ...
        \hline
        Resistencia terminal & 4.1 & $\Omega$ \\
        \hline
...
\subsection{Zhaowei}
    ...
    \begin{table}[H]
        ...
        Característica & Valor & Unidad \\
        \hline
        Resistencia terminal de fase & 4.5 & $\Omega$ \\
        \hline
