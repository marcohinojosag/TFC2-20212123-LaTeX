...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    En base a la comparativa presentada, se seleccionó el \textit{driver} VNH7070BAS por sus ventajas para el control de motores \ac{DC} y por su integración directa con el microcontrolador definido en la Sección~\ref{sec_sel_micro}. En particular, sus umbrales lógicos ($V_{IH}\geq \SI{2.1}{\volt}$) y ($V_{IL}\le \SI{0.9}{\volt}$)) permiten el control desde lógica a \SI{3.3}{\volt} sin adaptación de nivel. Adicionalmente, incorpora la salida de sensado CS, que entrega una corriente escalada proporcional a la corriente del motor, lo cual resulta conveniente para la etapa de medición y se detalla en la Sección~\ref{sec_sen_corr}.
