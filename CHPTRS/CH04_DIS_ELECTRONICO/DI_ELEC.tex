...
\section{Selección de componentes electrónicos}
    ...
    Para el control de los motores \ac{DC} del banco de pruebas, se evaluaron tres alternativas disponibles en el mercado local: dos módulos de desarrollo de uso común (L298N y BTS7960) y un integrado automotriz de mayor desempeño (VNH7070BAS). La \autoref{tab:hbridge_comp} resume la comparación en función de la topología, compatibilidad de niveles lógicos, capacidad de \ac{PWM}, sensado de corriente, protecciones e integración en \ac{PCB}.
   ...
   \subsection{Selección de sensor de corriente}
    ...
    \]
    donde \(\Delta I\) representa un término de corrección (sumado o restado) que se ajustará experimentalmente mediante la comparación con una medición de referencia obtenida con una pinza amperométrica, tal como se detalla en el Capítulo~\ref{ch:CH07}.
...
\section{Diagramas electrónicos}
    En esta sección se presenta el diagrama de conexiones entre la \ac{PCB} de control y la \ac{PCB} del sensor de efecto \textit{hall}. A continuación, se incluyen los diagramas esquemáticos correspondientes a ambos módulos, los cuales permiten identificar la interconexión de señales, alimentación y comunicaciones necesarias para su integración en el sistema. Asimismo, en el Anexo~\ref{an:Anexo_T} se presentan los diagramas esquemáticos completos, los \textit{layers} de la \ac{PCB} de dos capas y la vista previa en CAD de cómo se verían las \ac{PCB}s diseñadas.