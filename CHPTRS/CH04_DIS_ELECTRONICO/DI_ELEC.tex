...
\section{Selección de componentes electrónicos}
    ...
    \label{sec_sel_micro}
        ...
        \begin{subfigure}{0.32\textwidth}
            ...
            \caption*{\footnotesize\textit{Figura tomada de \cite{REF_ARDUINO_IMG}, s.f.-a.}}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.32\textwidth}
            \centering
            ...
            \caption*{\footnotesize\textit{Figura tomada de \cite{REF_ESP32_IMG}, s.f.-b.}}
        \end{subfigure}
        \hfill
        \begin{subfigure}{0.32\textwidth}
            \centering
            ...
            \caption*{\footnotesize\textit{Figura tomada de \cite{REF_STM32_IMG}, s.f.-c.}}
        \end{subfigure}
    ...
    \subsection{Selección de sensor de efecto \textit{hall}}
        ...
        Como se indicó en la Sección~\ref{sec:solucion_optima} del Capítulo~\ref{ch:CH03-Diseno-Conceptual}, se empleará un sensor de efecto \textit{hall} para estimar la velocidad angular del motor. Dado que los motores \ac{DC} presentan transitorios rápidos, se requiere un sensor con lectura ágil y una integración sencilla con el microcontrolador seleccionado.
    ...
    \caption{VNH7070BAS}
    \caption*{\footnotesize\textit{Nota: Figura tomada de \cite{[FUENTE_VNH]}, s.f.}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
    \vspace{0pt}
    ...
    \caption{L298N}
    \caption*{\footnotesize\textit{Nota: Figura tomada de \cite{[FUENTE_L298N]}, s.f.}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
    \vspace{0pt}
    ...
    \caption{BTS7960}
    \caption*{\footnotesize\textit{Nota: Figura tomada de \cite{[FUENTE_BTS7960]}, s.f.}}
    \end{subfigure}
   ...
   \subsection{Selección de sensor de corriente}
    ...
    \]
    donde \(\Delta I\) representa un término de corrección (sumado o restado) que se ajustará experimentalmente mediante la comparación con un sensor de corriente de referencia en el Capítulo~\ref{implementación}.
...
\section{Diseño de \ac{PCB}}
    ...
    Mecánicamente, la placa debe alinearse para mantener el imán coaxial al encapsulado, de modo que el centro del imán coincida con el centro del CI y se conserve una holgura axial estable.
        ...
        \medskip
        La programación detallada se desarrollará en el Capítulo \ref{ch:CH07_Implementacion} de Pruebas del Prototipo; de forma resumida se configurarán:
        \begin{itemize}
    ...
    \subsection{Diseño de circuitos de comunicación}
        ...
        \begin{figure}[H]
           \centering
           \includegraphics[width=1\textwidth]{CHPTRS/CH04_DIS_ELECTRONICO/Fig_Esquematicos/Esquema_CH340.JPG}
